    ...
    return (
        <div className="space-y-10 min-w-0 overflow-hidden animate-fade-in pb-12">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                <div className="space-y-2">
                    ...
                    <p className="text-dark-400 font-bold flex items-center gap-2 uppercase tracking-widest text-[10px]">
                        ...
                        Analytics Engine: <span className="text-white">Active Dispatch</span>
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    { title: "Daily Threat Feed", desc: "Ringkasan otomatis 24 jam untuk anomali jaringan kritis dan node sumber yang diblokir.", icon: <Calendar className="w-8 h-8 text-neon-cyan" strokeWidth={2} /> },
                    { title: "GNN Model Audit", desc: "Metrik performa detail dari mesin inferensi Graph Neural Network.", icon: <Brain className="w-8 h-8 text-hyper-violet" strokeWidth={2} /> },
                    { title: "Compliance Suite", desc: "Hasilkan laporan terstandarisasi untuk badan pengawas regulasi seperti PCI-DSS, SOC2, dan ISO-27001.", icon: <ShieldCheck className="w-8 h-8 text-status-success" strokeWidth={2} /> },
                ].map((card, idx) => (
            ...
            <div className="glass-panel p-6 md:p-10 rounded-[2.5rem] md:rounded-[3rem] relative group overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div className="flex items-center gap-2">
                        <h3 className="text-2xl font-black text-white tracking-tighter uppercase italic">Dispatch <span className="text-hyper-violet">History</span></h3>
                    ...
                    <table className="w-full border-separate border-spacing-y-3">
                        <thead>
                            <tr className="text-left text-[10px] font-black text-dark-500 uppercase tracking-[0.2em]">
                                <th className="pb-4 pl-8">Protocol Name</th>
                                <th className="pb-4">Classification</th>
                                <th className="pb-4">Generation Time</th>
                                <th className="pb-4">Data Volume</th>
